...
const healthPayload = () => ({
  ...
  estop: {
    ...
    // Origin of the active stop. The mock has NO ENCODER and cannot originate a
    // local stop — it reports whatever origin the server told it, never
    // 'local' of its own accord. Same honesty principle as verify:
    // 'unsupported': it does not pretend to a capability the hardware lacks.
